...
*/
contract OldPXLProperty is StandardToken {
    /* ERC-20 MetaData */
    ...
    /* ### Constructor ### */
    function OldPXLProperty(address oldAddress) public {
        inMigrationPeriod = true;
        oldPXLProperty = OldPXLProperty(oldAddress);
